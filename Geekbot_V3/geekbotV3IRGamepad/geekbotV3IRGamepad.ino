/*******************************************************************************
 *                       RobotGeek Geekbot V3 IR Gamepad
 *                                                             __________________
 *                                                              |              |
 *                                                              |     ___      |
 *                                                             _|____/___\ ____|_
...
//Easy - Rough Speed Configuration
//Changing these variables will result in the need to adjust your trim. 
int modMaxSpeed = 100;    //Change this variable to make the Geekbot go faster/slower when driving forward and backward when you first turn it on. Normal range between 0-300
...
//Advanced - Fine Speed Configuration - Servo wheel speeds in microseconds
