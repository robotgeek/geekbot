...
//Speed constants
const int SERVO_DRIVE_SPEED = 100; //Change drive speed, 0-100
const int SERVO_TURN_SPEED = 100; //For in place turning. Applied to left and rightFwdSpeed, used at intersections
const int SERVO_DRIVE_TURN_SPEED = 100; //For turning while driving

//Servo speeds
const int leftFwdSpeed = CCW_MIN_SPEED + 100 + SERVO_DRIVE_SPEED;
const int rightFwdSpeed = CW_MIN_SPEED - 100 - SERVO_DRIVE_SPEED;
